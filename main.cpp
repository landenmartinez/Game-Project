...
void Rhoten(Hero hero1, villain villain1) {
  ...
  cout << "Looking up ahead of you, you see a red, black, and white figure. It's posture is the same as a human's. The pointed claws of the creature glisten of light grey. A black bag in "
          "the shape of an envelope rests on its thigh with a handle looping around the neck of the bod. A red witch hat covers most of the fur on its head. You struggle to see the behind" 
          "of the figure as its black cape blocks the sight. ";
  dice chance_descript(20)
}
...
void Son(Hero hero1, villain villain1) {
  void son(Hero hero1, villain villain1) {
    ...
    cout << "While you keep walking, you come across a very dark green patch "
        "of.. water?"
        << endl;                                                     // story
    cout << "The 'water' slowly, slooowly starts to grow..." << endl << endl; // story
    cout << "As it grows, you realize that it's.. alive!?" << endl << "The weird lake thing "
        "groans and bubbles, and while you can't see it's face," << endl << "you feel "
        "like you've disturbed it, somehow."
        << endl << endl; // story
    cout << "The thing rises to its full height, and it appears to be a sort "
        "of slime monster." << endl << "But compared to normal slimes, it's super huge! And super "
        "angry..."
        << endl
        << endl; // story
    ...
    /* WHILE HERO IS ALIVE  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    while (hpH != 0) { // while the heros health is not at 0
        ...
        case 1:           // attack
            ...
            cout << "Your HP: " << hero1.getHealth() << endl << endl;
            cout << "1. Heavy Attack \t 2. Light Attack" << endl << endl; // ask for heavy or light atk
        ...
        case 2:             // if they want to use a potion
            ...
            cout << "You used a potion! " << endl << "You gain 50 health." << endl << "You now have " << hero1.getHealth() << " health." << endl;
        ...
        cout << endl << endl << "Sludge's turn!" << endl;
        
        atkV = villain1.attack();
        hero1.loss_health(atkV);
        cout << "Your HP: " << hero1.getHealth() << endl;
        cout << "Sludge's HP: " << villain1.getHealth() << endl << endl;
